    ...
    <div className="container mx-auto px-4 py-8 relative">
      ...
      {repositories.length === 0 ? (
        <div className="bg-card rounded-xl border border-border p-12 text-center relative z-10">
          ...
          <h2 className="text-xl font-semibold mb-2">No saved repositories yet</h2>
          <p className="text-muted-foreground mb-6">
        ...
        <div className="bg-card rounded-xl border border-border p-12 text-center relative z-10">
          ...
          <h2 className="text-xl font-semibold mb-2">No matching repositories</h2>
          <p className="text-muted-foreground mb-6">
                    ...
                    <div>
                      ...
                      {repo.notes && (
                        <div className="bg-muted/50 rounded-md p-3 mb-3">
                          <p className="text-sm">
                            <span className="font-semibold">Your notes:</span> {repo.notes}
                          </p>
                        </div>
                      )}
                      ...
                      <div className="flex flex-wrap gap-3 mb-3">
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-sm">{formatNumber(repo.issues)}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-sm">Updated {formatDate(repo.updatedAt.toISOString())}</span>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-sm">{formatFileSize(repo.size)}</span>
                        </div>
                      </div>
